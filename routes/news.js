...
const { allNews, postNews, updateNews, deleteNews, getNewsId } = require('../controllers/news');
...
const { uploadNewsValidation, updateNewsValidation } = require('../middlewares/news/newsMiddleware');
...
router.post('/', validJWT, hasRole('Admin'),uploadNewsValidation, postNews);
