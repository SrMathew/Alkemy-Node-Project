...
describe("News Controller methods", function () {    
  beforeEach(function () {
    sinon.stub(News,"findAll")
        .returns({name: "News", 
            image: "https://www.designevo.com/res/templates/thumb_small/colorful-hand-and-warm-community.png",
            content: "News about an Organization",
            categoryId: 2});
    sinon.stub(News,"findOne")
        .returns({name: "News", 
            image: "https://www.designevo.com/res/templates/thumb_small/colorful-hand-and-warm-community.png",
            content: "News about an Organization",
            categoryId: 2});
    sinon.stub(News,"findAndCountAll")
        .returns({name: "News", 
            image: "https://www.designevo.com/res/templates/thumb_small/colorful-hand-and-warm-community.png",
            content: "News about an Organization",
            categoryId: 2});
    sinon.stub(News,"findByPk")
        .returns({name: "News", 
            image: "https://www.designevo.com/res/templates/thumb_small/colorful-hand-and-warm-community.png",
            content: "News about an Organization",
            categoryId: 2});
    sinon.stub(News,"create")
        .returns({name: "News", 
            image: "https://www.designevo.com/res/templates/thumb_small/colorful-hand-and-warm-community.png",
            content: "News about an Organization",
            categoryId: 2});
 ...
 it("should test if the allNews method uses the stubs and returns fake News", async function () {
    req = {query: {page: 2}};
    res = {
 ...
 it("should test if the getNewsId method uses the stubs and returns fake News", async function () {
    req = {params: 1};
    res = {
      status: status => status,
      send: response => response 
 ...
 it("should test if the postNews method uses the stubs and returns createdNews", async function () {
    req = {};
    res = {
      status: status => status,
      send: response => response 
 ...
 it("should test if the deleteNews method uses the stubs and returns deletedNews", async function () {
    req = {params: 1};
    res = {
      status: status => status,
      send: response => response 
 ...
 it("should test if the updateNews method uses the stubs and returns updatedNews", async function () {
    req = {params: 1};
    res = {
      status: status => status,
      send: response => response 
